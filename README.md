# HST WINDOWS UTILITY - ELECTRON DESKTOP APP VERSION

![HST Interface](./HST.jpg)

## Overview
HST UTILITY is a powerful Windows utility designed to optimize your system's performance by providing easy access to various system configurations and tweaking options. It's perfect for gamers looking to maximize their hardware efficiency.
...
- **Visual Effects**: Lower visual effects
- **Dark Mode**: Switch Windows to dark mode
- **HST Power Plan**: Apply HST power plan for maximum performance
...
- **Browser Cache**: Clear Chrome browser cache (Will be updated)
- **Event Logs**: Clean up system event logs
- **Power Plans**: Remove default power plans
