            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <NeonButton
                            onClick={() =>
                                executeApiCall("disable-updates", "DISABLING WINDOWS UPDATES...")
                            }
                            icon={DownloadCloud}
                            gradient="linear-gradient(135deg, #0a0a0a 0%, #000000 100%)"
                            textColor="#22c55e"
                        ...
                        <NeonButton
                            onClick={() =>
                                executeApiCall("set-powerplan", "ADDING AND ACTIVATING POWER PLAN...")
                            }
                            icon={Battery}
                            gradient="linear-gradient(135deg, #0a0a0a 0%, #000000 100%)"
                            textColor="#a855f7"
                        ...
                        <NeonButton
                            onClick={() =>
                                executeApiCall(
                                    "remove-startup-apps", "REMOVING STARTUP APPS..."
                                )
                            }
                            icon={Zap}
                            gradient="linear-gradient(135deg, #0a0a0a 0%, #000000 100%)"
                    ...
                    <OptionsPanel
                        ...
                        onExecute={() => {
                            ...
                            if (selected.length === 0) {
                                ...
                                executeApiCall("debloat-apps", `DEBLOATING WINDOWS...`, body);
                            }
                        }}
                        color="#ffffff"
                        gradient="linear-gradient(135deg, #1a1a1a 0%, #0a0a0a 100%)"
                    ...
                    <OptionsPanel
                        ...
                        onExecute={() => {
                            ...
                            if (selected.length === 0) {
                                ...
                                executeApiCall("cleanup", `CLEANING WINDOWS...`, body);
                            }
                        }}
                        color="#ffffff"
                        gradient="linear-gradient(135deg, #1a1a1a 0%, #0a0a0a 100%)"
